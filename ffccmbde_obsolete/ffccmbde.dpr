...
begin
  ...
  case c of
    ...
    $80005D00: s:='©'; // ∞C
    $80005E00: s:='Щ'; // cm
    $80005F00: s:='@'; // треугольник

    $40270000: s:='<btn_cross>';
    $40290000: s:='<btn_triangle>';
    $402A0000: s:='<btn_square>';
    ...
    begin
      ...
      while not EOF(f) do
        begin
          ...
          // читаем количество символов в файле, включа€ 400х0000
